...
void Bits2Num_5_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Bits2Num_5_run(uint ctx_index,Circom_CalcWit* ctx);
void Bits2Num_strict_6_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Bits2Num_strict_6_run(uint ctx_index,Circom_CalcWit* ctx);
...
void LessEqThan_10_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void LessEqThan_10_run(uint ctx_index,Circom_CalcWit* ctx);
void MultiMux1_11_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void MultiMux1_11_run(uint ctx_index,Circom_CalcWit* ctx);
void Mux1_12_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void Mux1_12_run(uint ctx_index,Circom_CalcWit* ctx);
void ShipHit_13_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void ShipHit_13_run(uint ctx_index,Circom_CalcWit* ctx);
void ShipHit_14_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void ShipHit_14_run(uint ctx_index,Circom_CalcWit* ctx);
void ShipHit_15_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void ShipHit_15_run(uint ctx_index,Circom_CalcWit* ctx);
void ShipHit_16_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void ShipHit_16_run(uint ctx_index,Circom_CalcWit* ctx);
void FireShot_17_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void FireShot_17_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 15886;}

uint get_number_of_components() {return 128;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 10859;}
...
Fr_shr(&expaux[1],&circuitConstants[439],&expaux[3]); // line circom 45
...
Fr_shr(&expaux[1],&circuitConstants[439],&expaux[3]); // line circom 46
...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[441]); // line circom 30
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[441]); // line circom 61
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[1];
// load src
...
PFrElement aux_dest = &lvar[3];
// load src
Fr_add(&expaux[0],&lvar[3],&circuitConstants[3]); // line circom 61
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[441]); // line circom 61
...
ctx->componentMemory[coffset].templateName = "Bits2Num_strict";
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 254;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
...
mySubcomponents[aux_create+i] = aux_cmp_num;
Bits2Num_5_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 255 ;
aux_cmp_num += 1;
}
}
...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[441]); // line circom 76
while(Fr_isTrue(&expaux[0])){
{
...
// run sub component if needed
if(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter)){
Bits2Num_5_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[0];
// load src
Fr_add(&expaux[0],&lvar[0],&circuitConstants[3]); // line circom 76
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[441]); // line circom 76
...
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 1],&circuitConstants[33]); // line circom 96
...
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
Fr_sub(&expaux[0],&circuitConstants[3],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 4]); // line circom 98
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
}
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 1],&circuitConstants[3]); // line circom 138
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// need to run sub component
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 2],&circuitConstants[3]); // line circom 112
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// need to run sub component
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[3]); // line circom 26
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
...
mySubcomponents[aux_create+i] = aux_cmp_num;
MultiMux1_11_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 4 ;
aux_cmp_num += 1;
}
}
...
PFrElement aux_dest = &lvar[0];
// load src
Fr_add(&expaux[0],&lvar[0],&circuitConstants[3]); // line circom 41
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[5]); // line circom 41
...
// need to run sub component
assert(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
MultiMux1_11_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
...
ctx->componentMemory[coffset].templateName = "ShipHit";
ctx->componentMemory[coffset].signalStart = soffset;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "startXGeq";
mySubcomponents[aux_create+i] = aux_cmp_num;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "startYGeq";
mySubcomponents[aux_create+i] = aux_cmp_num;
GreaterEqThan_9_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 12 ;
aux_cmp_num += 3;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "endXLeq";
mySubcomponents[aux_create+i] = aux_cmp_num;
LessEqThan_10_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 12 ;
aux_cmp_num += 3;
}
}
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "startYLeq";
mySubcomponents[aux_create+i] = aux_cmp_num;
LessEqThan_10_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 12 ;
aux_cmp_num += 3;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "startXLeq";
mySubcomponents[aux_create+i] = aux_cmp_num;
LessEqThan_10_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 12 ;
aux_cmp_num += 3;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "endYLeq";
mySubcomponents[aux_create+i] = aux_cmp_num;
LessEqThan_10_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 12 ;
aux_cmp_num += 3;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "shipShotOrientationMuxer";
mySubcomponents[aux_create+i] = aux_cmp_num;
Mux1_12_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 8 ;
aux_cmp_num += 2;
}
}
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 1],&circuitConstants[11]); // line circom 30
...
// need to run sub component
assert(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
LessEqThan_10_run(mySubcomponents[cmp_index_ref],ctx);
}
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 2],&circuitConstants[11]); // line circom 46
Fr_sub(&expaux[0],&expaux[1],&circuitConstants[3]); // line circom 46
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// need to run sub component
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[3]].signalStart + 0]); // line circom 50
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// no need to run sub component
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[4]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[5]].signalStart + 0]); // line circom 51
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// need to run sub component
assert(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
Mux1_12_run(mySubcomponents[cmp_index_ref],ctx);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 6];
// load src
Fr_mul(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 0]); // line circom 54
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 6],&ctx->signalValues[ctx->componentMemory[mySubcomponents[6]].signalStart + 0]); // line circom 57
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
}
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 1],&circuitConstants[9]); // line circom 30
Fr_sub(&expaux[0],&expaux[1],&circuitConstants[3]); // line circom 30
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 2],&circuitConstants[9]); // line circom 46
Fr_sub(&expaux[0],&expaux[1],&circuitConstants[3]); // line circom 46
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 1],&circuitConstants[7]); // line circom 30
Fr_sub(&expaux[0],&expaux[1],&circuitConstants[3]); // line circom 30
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 2],&circuitConstants[7]); // line circom 46
Fr_sub(&expaux[0],&expaux[1],&circuitConstants[3]); // line circom 46
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 1],&circuitConstants[5]); // line circom 30
Fr_sub(&expaux[0],&expaux[1],&circuitConstants[3]); // line circom 30
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_add(&expaux[1],&signalValues[mySignalStart + 2],&circuitConstants[5]); // line circom 46
Fr_sub(&expaux[0],&expaux[1],&circuitConstants[3]); // line circom 46
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
...
ctx->componentMemory[coffset].templateName = "FireShot";
ctx->componentMemory[coffset].signalStart = soffset;
...
uint csoffset = mySignalStart+15450;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "shipHits[0]";
mySubcomponents[aux_create+i] = aux_cmp_num;
ShipHit_13_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
}
}
...
uint csoffset = mySignalStart+15537;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "shipHits[1]";
mySubcomponents[aux_create+i] = aux_cmp_num;
ShipHit_14_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
}
}
...
uint csoffset = mySignalStart+15624;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "shipHits[2]";
mySubcomponents[aux_create+i] = aux_cmp_num;
ShipHit_15_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
}
}
...
uint csoffset = mySignalStart+15711;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "shipHits[3]";
mySubcomponents[aux_create+i] = aux_cmp_num;
ShipHit_15_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
...
uint csoffset = mySignalStart+15798;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "shipHits[4]";
mySubcomponents[aux_create+i] = aux_cmp_num;
ShipHit_16_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 0 ;
aux_cmp_num += 0;
}
}
...
uint aux_create = 6;
int aux_cmp_num = 17+ctx_index+1;
uint csoffset = mySignalStart+14167;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "shipBitlistToInteger";
mySubcomponents[aux_create+i] = aux_cmp_num;
Bits2Num_strict_6_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 1283 ;
aux_cmp_num += 5;
}
}
...
Fr_lt(&expaux[0],&lvar[5],&circuitConstants[31]); // line circom 27
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 0;
{
...
// load src
Fr_idiv(&expaux[0],&lvar[5],&circuitConstants[7]); // line circom 28
Fr_mod(&expaux[0],&lvar[5],&circuitConstants[7]); // line circom 28
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((3 * Fr_toInt(&expaux[0])) + (1 * Fr_toInt(&expaux[0]))) + 3)]);
}
// run sub component if needed
if(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter)){
MiMCSponge_1_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[5];
// load src
Fr_add(&expaux[0],&lvar[5],&circuitConstants[3]); // line circom 27
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[5],&circuitConstants[31]); // line circom 27
}
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0],&signalValues[mySignalStart + 1]); // line circom 31
...
// load src
Fr_idiv(&expaux[0],&signalValues[mySignalStart + 2],&circuitConstants[21]); // line circom 37
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[2],&signalValues[mySignalStart + 20],&circuitConstants[21]); // line circom 38
Fr_sub(&expaux[0],&signalValues[mySignalStart + 2],&expaux[2]); // line circom 38
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_mul(&expaux[2],&signalValues[mySignalStart + 20],&circuitConstants[21]); // line circom 40
Fr_add(&expaux[1],&expaux[2],&signalValues[mySignalStart + 19]); // line circom 40
Fr_eq(&expaux[0],&expaux[1],&signalValues[mySignalStart + 2]); // line circom 40
...
Fr_lt(&expaux[0],&lvar[5],&circuitConstants[11]); // line circom 45
while(Fr_isTrue(&expaux[0])){
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((3 * Fr_toInt(&lvar[5])) + 0) + 3)]);
}
// run sub component if needed
if(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter)){
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((3 * Fr_toInt(&lvar[5])) + 1) + 3)]);
}
// run sub component if needed
if(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((3 * Fr_toInt(&lvar[5])) + 2) + 3)]);
}
// run sub component if needed
if(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter)){
(*_functionTable[ctx->componentMemory[mySubcomponents[cmp_index_ref]].templateId])(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[5])) + 1)]].signalStart + ctx->templateInsId2IOSignalInfo[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[5])) + 1)]].templateId].defs[0].offset]);
}
// run sub component if needed
if(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter)){
Bits2Num_strict_6_run(mySubcomponents[cmp_index_ref],ctx);
...
PFrElement aux_dest = &lvar[5];
// load src
Fr_add(&expaux[0],&lvar[5],&circuitConstants[3]); // line circom 45
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[5],&circuitConstants[11]); // line circom 45
...
Fr_lt(&expaux[0],&lvar[5],&circuitConstants[441]); // line circom 57
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 6;
{
...
PFrElement aux_dest = &lvar[5];
// load src
Fr_add(&expaux[0],&lvar[5],&circuitConstants[3]); // line circom 57
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[5],&circuitConstants[441]); // line circom 57
...
FireShot_17_create(1,0,ctx,"main",0);
FireShot_17_run(0,ctx);
}
